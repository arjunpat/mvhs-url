<template>
  <div id="app" style="height: 100%;">
    ...
    <div style="padding: 10px; text-align: center; font-size: 7px;">This website has no affiliation with, and is not endorsed by, Mountain View High School. <a @click="$router.push({ path: '/about' })" style="color: blue; cursor: pointer; text-decoration: underline;">See more information here.</a></div>
  </div>
</template>
